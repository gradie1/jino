...
//OFFSET
 ...
 isOffsetBottom : function(){
	if(this.position.getY()+this.h>=vw(110)){
			return true;
		}
},
...
setRectPush : function(body){
	...
	rightCollide : function(body){
		if(this.position.getY()>=body.position.getY()-this.h && this.position.getY()+this.h<=body.position.getY()+body.h+this.h && this.position.getX()>=body.position.getX()+body.w-10){
			if(this.position.getX()<=body.position.getX()+body.w+0.1 ){
				return true;
			}
		}
	},
	...
	leftCollide : function (body){
		if(this.position.getY()>=body.position.getY()-this.h && this.position.getY()+this.h<=body.position.getY()+body.h+this.h && this.position.getX()+this.w<=body.position.getX()+10){

			if(this.position.getX()+this.w>=body.position.getX()-0.1){
				return true;
			}
		}
	},
	...
	collide: function(body){
		if(this.leftCollide(body)&&this.rightCollide(body)&&this.topCollide(body)&&this.bottomCollide(body)){
			return true;
		}
	},
	...
	setRectCollision : function(body){
		...
		if(this.position.getY()>=body.position.getY()-this.h && this.position.getY()+this.h<=body.position.getY()+body.h+this.h && this.position.getX()>=body.position.getX()+body.w-10){
			if(this.position.getX()<=body.position.getX()+body.w ){
				this.position.setX(body.position.getX()+body.w+0.1);
			}
		}//bottom
		if(this.position.getX()+this.w>=body.position.getX() && this.position.getX()+this.w<=body.position.getX()+body.w+this.w && this.position.getY()<=body.position.getY()+body.h){
			if(this.position.getY()>body.position.getY()){
		...
		if(this.position.getY()+this.h>=body.position.getY() && this.position.getY()<=body.position.getY()+body.h && this.position.getX()+this.w<=body.position.getX()+20){

			if(this.position.getX()+this.w>=body.position.getX()){
				
				this.position.setX(body.position.getX()-this.w-0.1);
